...
from generic_grader.class_.instance_attributes_match_reference import build
...
def test_instance_attributes_match_reference_build_class(built_class):
    """Test that the style comments build function returns a class."""
    assert issubclass(built_class, unittest.TestCase)


def test_instance_attributes_match_reference_build_class_name(built_class):
    """Test that the built_class has the correct name."""
    assert built_class.__name__ == "TestInstanceAttributesMatchReference"


def test_instance_attributes_match_reference_built_instance_type(built_instance):
    """Test that the built_class returns instances of unittest.TestCase."""
    assert isinstance(built_instance, unittest.TestCase)


def test_instance_attributes_match_reference_has_test_method(built_instance):
    """Test that instances of the built_class have test method."""
    assert hasattr(built_instance, "test_instance_attributes_match_reference_0")
...
def case_test_method(request, fix_syspath):
    ...
    built_instance = built_class(
        methodName="test_instance_attributes_match_reference_0"
    )
    test_method = built_instance.test_instance_attributes_match_reference_0
